...
The purpose of the following script is to simulate the imaging modulation transfer function from 
a GE-EPI from imaging of a thin slid. The slid is parallel to the x-direction (read direction). The 
...
output = nb.Nifti1Image(input, np.eye(4), nb.Nifti1Header())
