...
for i in range(2):
    data["wSurface"][0][i] = apply_affine_chunked(ras2vox_tkr,
                                                  data["wSurface"][0][i])
    data["pSurface"][0][i] = apply_affine_chunked(ras2vox_tkr,
                                                  data["pSurface"][0][i])
...
for i in range(2):
    ...
    data["wSurface"][0][i] = apply_affine_chunked(vox2ras_tkr,
                                                  data["wSurface"][0][i])
    data["pSurface"][0][i] = apply_affine_chunked(vox2ras_tkr,
                                                  data["pSurface"][0][i])
