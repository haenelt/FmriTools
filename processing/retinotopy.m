...
% input data
input.pol.data.pos = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh4/19883.56/retinotopy/pol_anticlock/udata.nii'; % anticlock
input.pol.data.neg = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh4/19883.56/retinotopy/pol_clock/udata.nii'; % clock
...
input.ecc.data.pos = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh4/19883.56/retinotopy/ecc_expanding/udata.nii'; % expanding
input.ecc.data.neg = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh4/19883.56/retinotopy/ecc_contracting/udata.nii'; % contracting
input.ecc.tr = 2;
input.ecc.period = 32;
input.ecc.fix = 12;
input.ecc.freq = 8.25;
