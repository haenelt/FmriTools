...
Since the corrected vaso time series is regridded to a new TR, outlier lists e.g. to censor single 
volumes based on the realignment procedure, are transformed to the corresponding timepoints in the 
