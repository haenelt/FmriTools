...
% to its length and if the ratio exceeds a defined threshold, the whole run
% is discarded. Additionally, regressors for neglecting outlier volumes are
% created.
%
...
% input time series
img_input = {
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_1/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_2/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_3/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_4/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_5/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_6/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_7/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_8/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_9/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_10/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_11/data.nii',...
    '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/Run_12/data.nii',...
    };

% input fieldmap
fmap_magn = '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/fmap/fmap1_TE6.nii';
fmap_phase = '/data/pt_01880/V2STRIPES/p7/colour/GE_EPI1/fmap/fmap2_DeltaTE1p02.nii';
...
% fieldmap parameters
fieldmap_undistortion = true; % run fieldmap undistortion
...
for i = 1:length(img_input)
    ...
    for j = 1:length(M(:,1))-1
        for k = 1:6 % number of motion parameters
...
path_diagnosis = fileparts(fileparts(img_input{1}));
if ~exist(path_diagnosis,'dir') 
    mkdir(path_diagnosis); 
end

% open textfile
fileID = fopen(fullfile(path_diagnosis,'preprocessing_summary.txt'));
...
for i = 1:length(img_input)
    ...
    data_array = spm_get_vols(data_img);
...
data_img_out(1).fname = fullfile(path_diagnosis, 'vol1.nii');
spm_write_vol(data_img_out(1), data_mean);
