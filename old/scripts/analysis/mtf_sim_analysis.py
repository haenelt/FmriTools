...
ymri_fft[:ky_sample, -1 : -kx_sample - 1 : -1] = y_fft[
    :ky_sample, -1 : -kx_sample - 1 : -1
]
ymri_fft[-1 : -ky_sample - 1 : -1, :kx_sample] = y_fft[
    -1 : -ky_sample - 1 : -1, :kx_sample
]
ymri_fft[-1 : -ky_sample - 1 : -1, -1 : -kx_sample - 1 : -1] = y_fft[
    -1 : -ky_sample - 1 : -1, -1 : -kx_sample - 1 : -1
]
...
fig.savefig(
    os.path.join(path_output, "mtf_example.svg"), format="svg", bbox_inches="tight"
)
plt.show()
