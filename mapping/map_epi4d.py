...
deformation field. The transformed time series get the prefix r. Because of heap size limits, the 
time series is split and the déformation is applied separately to each volume.
