...
The purpose of the following script is to match the number of vertices between 
deformed white and pial surfaces. Vertices are removed which are not found in 
both surfaces. After removing, faces vertex-in-orig indices are updated.
