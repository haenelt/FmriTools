...
% input data
img_input = {
    '/data/pt_01880/Experiment6_Albinism/p1/odc/GE_EPI1/Run_1/udata.nii',...
    '/data/pt_01880/Experiment6_Albinism/p1/odc/GE_EPI1/Run_2/udata.nii',...
    '/data/pt_01880/Experiment6_Albinism/p1/odc/GE_EPI1/Run_3/udata.nii',...
    };
...
name_sess = 'test2'; % name of session (if multiple sessions exist)
name_output = ''; % basename of output contrasts
output_folder = 'contrast_test2'; % name of folder where spm.mat is saved
