...
fig.savefig(os.path.join(path_output, "exp_fwhm_vs_depth.svg"),
...
ax.set_title("ODCs along minor axis")
plt.yticks(y, np.round(y[::-1], 1))
fig.savefig(os.path.join(path_output, "exp_column_kfft_vs_depth.svg"),
            format='svg', bbox_inches='tight')
plt.show()
...
ax.set_title("ODCs along minor axis")
plt.yticks(y, np.round(y[::-1], 1))
fig.savefig(os.path.join(path_output, "exp_column_Pfft_vs_depth.svg"),
            format='svg', bbox_inches='tight')
plt.show()
...
fig.savefig(os.path.join(path_output, "exp_fwhm_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
ax.set_title("ODCs along different projections")
fig.savefig(os.path.join(path_output, "exp_kfft_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
ax.set_title("ODCs along different projections")
fig.savefig(os.path.join(path_output, "exp_Pfft_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
# nyquist frequency
f_ny = np.sqrt(Nx_mri ** 2 + Ny_mri ** 2) / (
            2 * np.sqrt(FOVx_mri ** 2 + FOVy_mri ** 2))
...
for i in range(4):
    ...
    fig.savefig(
        ...
        format='svg', bbox_extra_artists=(axins,), bbox_inches='tight')
    plt.show()
