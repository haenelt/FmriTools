...
fig.savefig(os.path.join(path_output, "sim_fwhm_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
fig.savefig(os.path.join(path_output, "sim_kfft_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
ax.set_title("ODCs along different projections")
# fig.savefig(os.path.join(path_output,"sim_Pfft_vs_phi.svg"), format='svg',
#             bbox_inches='tight')
fig.savefig(os.path.join(path_output, "sim_Pfft_vs_phi_threshold.svg"),
...
ax.set_title("ODCs along different projections")
fig.savefig(os.path.join(path_output, "sim_dacorr_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
ax.set_title("ODCs along different projections")
fig.savefig(os.path.join(path_output, "sim_Pacorr_vs_phi.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
fig.savefig(os.path.join(path_output, "sim_fft_example.svg"), format='svg',
            bbox_inches='tight')
plt.show()
...
ax.legend(["minor axis", "major axis"], frameon=False)
fig.savefig(os.path.join(path_output, "sim_acorr_example.svg"), format='svg',
            bbox_inches='tight')
plt.show()
