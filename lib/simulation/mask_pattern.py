def mask_pattern_2d(nx, ny, a, b, alpha):
    """
    This function computes a mask to occlude parts of the columnar pattern. The mask has elliptical
    shape and can be adjusted by its major and minor axes and a rotational angle.
    Inputs:
