...
resample.inputs.in_file = os.path.join(path_levelset,
                                       "wm_border_p2l-surf.nii.gz")
resample.inputs.outputtype = "NIFTI_GZ"
resample.inputs.out_file = os.path.join(path_levelset,
                                        "wm_border_p2l-surf_upsampled.nii.gz")
...
resample = afni.Resample()
resample.inputs.in_file = os.path.join(path_levelset,
                                       "csf_border_p2l-surf.nii.gz")
resample.inputs.outputtype = "NIFTI_GZ"
resample.inputs.out_file = os.path.join(path_levelset,
                                        "csf_border_p2l-surf_upsampled.nii.gz")
resample.inputs.resample_mode = "Li"
resample.inputs.voxel_size = (x_upsample, y_upsample, z_upsample)
resample.run()
...
csf = nb.load(
    os.path.join(path_levelset, "csf_border_p2l-surf_upsampled.nii.gz"))
