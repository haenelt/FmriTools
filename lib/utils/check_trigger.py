def check_trigger(input_biopac):
    """
    This function loads the digital input from a saved biopac mat-file and checks the number of sent
    triggers and the time difference between triggers.
    Inputs:
    ...
    # get time difference between following triggers (digital input is saved in ms)
