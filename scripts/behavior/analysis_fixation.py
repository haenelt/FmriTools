...
for i in range(len(file_in)):
    ...
    # get output folder
    path_output = os.path.join(os.path.dirname(os.path.dirname(file_in[i])),
                               "behavior")
    if not os.path.exists(path_output):
        os.makedirs(path_output)

    # get mat-file
    FixationData = loadmat(file_in[i])["FixationData"]
    ...
    fig.savefig(os.path.join(path_output, "fixation_task_hist.png"),
