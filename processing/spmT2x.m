...
% input
spm_mat_in = '/data/pt_01880/Experiment1_ODC/p1/odc/VASO2/contrast_all/SPM.mat'; % SPM.mat
path_output = '/data/pt_01880/Experiment1_ODC/p1/odc/results/'; % path where output is written
