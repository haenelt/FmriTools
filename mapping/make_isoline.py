...
mapped onto the grid representation of a flattened surface patch. Only contour lines which are 
continuous are considered. The purpose of this script is to estimate cortical length D which is 
defined as isoline between dorsal and ventral V1/V2 borders. This can be used to define cortical 
frequency F = 1 / 2D similar to Parkes et al., 2005.
