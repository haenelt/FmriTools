...
From the condition logfile of the binocular rivalry paradigm, the variable
SwitchData is read and analyzed. The mean and standard deviation of green and
red periods are estimated. The relative amount of piecemeal events is
calculated. This is just a quick overview of the condition file. Onsets are not
classified by their neighbours and not double button presses are considered.
...
file_in = "/home/raid2/haenelt/V2STRIPES/p4/rivalry/GE_EPI1/Run_8/logfiles/p4_GE_EPI1_Run8_rivalry_Cond.mat"
