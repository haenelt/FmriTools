...
# input files
input_surf = [
    "/data/pt_01983/func/anatomy/layer/lh.layer0",
...
input_deform2 = (
    "/data/pt_01983/func/deformation/MPM/sess1/mpm_2_mp2rage.nii.gz"  # mpm2ana
)
...
for i in range(len(input_surf)):
    ...
    # rename output
    os.rename(
        join(path_output, basename(input_surf[i]) + "_def_def"),
