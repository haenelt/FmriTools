...
ind["white_1"]["lh"] = "/data/pt_01880/Experiment2_Rivalry/p1/anatomy/dense_epi/lh.white_def2_ind"
ind["white_1"]["rh"] = "/data/pt_01880/Experiment2_Rivalry/p1/anatomy/dense_epi/rh.white_def2_ind"
...
ind["pial_1"]["lh"] = "/data/pt_01880/Experiment2_Rivalry/p1/anatomy/dense_epi/lh.pial_def2_ind"
ind["pial_1"]["rh"] = "/data/pt_01880/Experiment2_Rivalry/p1/anatomy/dense_epi/rh.pial_def2_ind"
...
for i in range(len(hemi)):
    ...
    vtx_white, vtx_pial, fac, _ = match_vertex_number(vtx_white,
                                                      vtx_pial,
                                                      fac,
                                                      ind_white,
                                                      ind_pial)

    file_white = os.path.join(path_dense,
                              hemi[i] + "." + basename_white + "_match")
    file_pial = os.path.join(path_dense,
                             hemi[i] + "." + basename_pial + "_match")
    ...
    # inflation
    inflate_surf_mesh(file_white + "_final",
