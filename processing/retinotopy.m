...
% input data
input.pol.data.pos = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh2/retinotopy/pollet_anticlock/udata.nii'; % anticlock
input.pol.data.neg = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh2/retinotopy/pollet_clock/udata.nii'; % clock
...
input.pol.cutoff = 128; % cutoff frequency 1/cutoff in Hz

input.ecc.data.pos = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh2/retinotopy/ecclet_expanding/udata.nii'; % expanding
input.ecc.data.neg = '/nobackup/actinium2/haenelt/ForOthers/RetinotopyFakhereh2/retinotopy/ecclet_contracting/udata.nii'; % contracting
input.ecc.tr = 2;
input.ecc.period = 32;
input.ecc.fix = 12;
input.ecc.freq = 8.25;
