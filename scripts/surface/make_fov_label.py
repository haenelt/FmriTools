...
from fmri_tools.surface.label import roi_fov
from fmri_tools.io.surf import write_label

# input
file_surf = ["/data/pt_01880/Experiment1_ODC/p1/anatomy/layer/lh.layer_0",
...
file_cmap = ["/data/pt_01880/Experiment1_ODC/p1/deformation/odc/GE_EPI3/source2target.nii.gz",
...
file_target = ["/data/pt_01880/Experiment1_ODC/p1/odc/GE_EPI3/diagnosis/mean_udata.nii",
