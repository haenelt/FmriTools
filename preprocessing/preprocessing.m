...
% fieldmap parameters
fieldmap_params.fieldmap_undistortion = false; % run fieldmap undistortion
fieldmap_params.fmap_magn = '';
fieldmap_params.fmap_phase = '';
fieldmap_params.fmap_te1 = 6.0; % shorter echo time in ms
fieldmap_params.fmap_te2 = 7.02; % longer echo time in ms
fieldmap_params.fmap_blipdir = 1; % phase-encoding direction
fieldmap_params.fmap_BandwidthPerPixelPhaseEncode = 16.304; % phase-encoding bandwidth Hz/px
