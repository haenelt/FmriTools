...
file_mean_epi_source = (
    "/data/pt_01880/Experiment3_Stripes/p3/colour/GE_EPI1/diagnosis/mean_data.nii"
)
...
os.rename(
    os.path.join(path_output, "ana2epi_def-img.nii.gz"),
    os.path.join(path_output, "ana2epi.nii.gz"),
)
os.rename(
    os.path.join(path_output, "epi2ana_def-img.nii.gz"),
...
os.rename(
    os.path.join(path_output, "ana2epi_example_def-img.nii.gz"),
    os.path.join(path_output, "ana2epi_example.nii.gz"),
)
os.rename(
    os.path.join(path_output, "epi2ana_example_def-img.nii.gz"),
