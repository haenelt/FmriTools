...
from ..simulation.odc import odc_2d
...
for i in range(niter):
    ...
    for j in range(len(phi)):
        ...
        fwhm_acorr, d_acorr, P_acorr, x_acorr, y_acorr = analyze_acorr(
            neural, FOVx, FOVy, x_temp, y_temp
        )
...
# save variables
np.savez(
    os.path.join(path_output, name_output),
    x_fft_0=x_fft_0,
    x_fft_90=x_fft_90,
    x_acorr_0=x_acorr_0,
    ...
    k_fft_phi_mean=k_fft_phi_mean,
    P_fft_phi_mean=P_fft_phi_mean,
    d_acorr_phi_mean=d_acorr_phi_mean,
    P_acorr_phi_mean=P_acorr_phi_mean,
    fwhm_acorr_phi_mean=fwhm_acorr_phi_mean,
    k_fft_phi_std=k_fft_phi_std,
    P_fft_phi_std=P_fft_phi_std,
    d_acorr_phi_std=d_acorr_phi_std,
    P_acorr_phi_std=P_acorr_phi_std,
