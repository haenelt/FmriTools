...
% input data
input.pol.data.pos = '/data/pt_01880/Experiment2_Rivalry/p4/retinotopy2/pol_anticlock/udata.nii'; % anticlock
input.pol.data.neg = '/data/pt_01880/Experiment2_Rivalry/p4/retinotopy2/pol_clock/udata.nii'; % clock
...
input.ecc.data.pos = '/data/pt_01880/Experiment2_Rivalry/p4/retinotopy2/ecc_expanding/udata.nii'; % expanding
input.ecc.data.neg = '/data/pt_01880/Experiment2_Rivalry/p4/retinotopy2/ecc_contracting/udata.nii'; % contracting
input.ecc.tr = 2;
input.ecc.period = 32;
input.ecc.fix = 12;
input.ecc.freq = 8.25;
