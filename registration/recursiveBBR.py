...
This script performs recurive BBR to register a functional data set with surfaces generated from a 
separate whole-brain anatomy.
...
scaling and translation can be modified. For example the combination `rystytz' would optimise for a 
rotation around the y-axis, a scaling in all direction and a translation along the y-axis and along 
the z-axis. The default is 'rst' for all transformations.
