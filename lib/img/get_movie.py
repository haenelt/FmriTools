def get_movie(input, path_output, name_output, coord, axis=0, fps = 10, transpose=True):
    """
    This function generates gif of a specific slice over a time series. It has the purpose to easily
