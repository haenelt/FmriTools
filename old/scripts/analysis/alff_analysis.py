...
# rest1, rest2, t, p, _ = analyze_alff_between_stripes(input_label,
#                                                      input_disparity,
#                                                      input_rest,
#                                                      min_contrast, nvert)

rest1, rest2, t, p, _ = analyze_alff_between_conditions(
    input_label, input_color, input_disparity, input_rest, min_contrast, nvert
)
