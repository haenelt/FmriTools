...
autocorrelation analysis of ODC data. Data are averaged across hemispheres and
two separate sessions. The following plots are
produced:
...
lh1 = np.load(
    "/home/daniel/mpi/conference/ohbm/ohbm_2019/poster/odc_exp/results/lh.GE_EPI4.npz"
)
lh2 = np.load(
    "/home/daniel/mpi/conference/ohbm/ohbm_2019/poster/odc_exp/results/lh.GE_EPI5.npz"
)
rh1 = np.load(
    "/home/daniel/mpi/conference/ohbm/ohbm_2019/poster/odc_exp/results/rh.GE_EPI4.npz"
)
rh2 = np.load(
    "/home/daniel/mpi/conference/ohbm/ohbm_2019/poster/odc_exp/results/rh.GE_EPI5.npz"
)
...
fig.savefig(
    os.path.join(path_output, "exp_fwhm_vs_depth.svg"),
    format="svg",
    bbox_inches="tight",
)
plt.show()
...
plt.yticks(y, np.round(y[::-1], 1))
fig.savefig(
    os.path.join(path_output, "exp_column_kfft_vs_depth.svg"),
    format="svg",
    bbox_inches="tight",
)
plt.show()
...
plt.yticks(y, np.round(y[::-1], 1))
fig.savefig(
    os.path.join(path_output, "exp_column_Pfft_vs_depth.svg"),
    format="svg",
    bbox_inches="tight",
)
plt.show()
...
fig.savefig(
    os.path.join(path_output, "exp_fwhm_vs_phi.svg"), format="svg", bbox_inches="tight"
)
plt.show()
...
ax.set_title("ODCs along different projections")
fig.savefig(
    os.path.join(path_output, "exp_kfft_vs_phi.svg"), format="svg", bbox_inches="tight"
)
plt.show()
...
ax.set_title("ODCs along different projections")
fig.savefig(
    os.path.join(path_output, "exp_Pfft_vs_phi.svg"), format="svg", bbox_inches="tight"
)
plt.show()
...
for i in range(4):
    ...
    axins = zoomed_inset_axes(
        ax, 2, loc=1, bbox_to_anchor=(10, 300)
    ...
    fig.savefig(
        os.path.join(path_output, "exp_fft_example_" + plot_suffix + ".svg"),
        format="svg",
...
for i in range(4):
    ...
    mark_inset(ax, axins, loc1=1, loc2=3, fc="none", ec="0.5")
    fig.savefig(
        os.path.join(path_output, "exp_acorr_example_" + plot_suffix + ".svg"),
        format="svg",
        bbox_extra_artists=(axins,),
        bbox_inches="tight",
    )
