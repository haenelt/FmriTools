function [wSurface, pSurface, faceData] = ft_surf2mat(lh_white, rh_white, ...
    lh_pial, rh_pial, save_output)
% Read surfaces
%
% [wSurface, pSurface, faceData] = ft_surf2mat(lh_white, rh_white, ...
%    lh_pial, rh_pial, save_output)
%
% Inputs:
...
%
% This function reads the white and pial surfaces generated by freesurfer
