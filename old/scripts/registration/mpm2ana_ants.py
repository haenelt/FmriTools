...
# input files
file_mpm_r1 = (
    "/home/daniel/Schreibtisch/mpm_reg/data/mpm/s122880a-145639-00001-00352-1_R1.nii"
)
file_mpm_pd = (
    "/home/daniel/Schreibtisch/mpm_reg/data/mpm/s122880a-145639-00001-00352-1_PD.nii"
)
...
matlab = MatlabCommand("ft_skullstrip_spm12", file_mp2rage_pd, path_mp2rage)
matlab.run()

print("skullstrip mpm")
matlab = MatlabCommand(
    "ft_skullstrip_spm12", os.path.join(path_mpm, "mpm_pd.nii"), path_mpm
)
matlab.run()
...
embedded_antsreg(
    os.path.join(path_mpm, "scanner_def-img.nii.gz"),  # source image
...
apply_coordinate_mappings(
    os.path.join(path_deformation, "rigid_ants-invmap.nii.gz"),  # input
...
os.rename(
    os.path.join(path_output, "mpm_2_mp2rage_def-img.nii.gz"),
    os.path.join(path_output, "mpm_2_mp2rage.nii.gz"),
)
os.rename(
    os.path.join(path_output, "mp2rage_2_mpm_def-img.nii.gz"),
...
# rename final deformation examples
os.rename(
    os.path.join(path_output, "mpm_2_mp2rage_example_def-img.nii.gz"),
    os.path.join(path_output, "mpm_2_mp2rage_example.nii.gz"),
)
os.rename(
    os.path.join(path_output, "mp2rage_2_mpm_example_def-img.nii.gz"),
