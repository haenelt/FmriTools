...
if ext_orig != ".nii":
    mri_convert(
        os.path.join(path_temp, "orig" + ext_orig), os.path.join(path_temp, "orig.nii")
    )
...
os.rename(
    os.path.join(path_output, "orig2T1_example_def-img.nii.gz"),
    os.path.join(path_output, "orig2T1_example.nii.gz"),
)
os.rename(
    os.path.join(path_output, "T12orig_example_def-img.nii.gz"),
