...
# input data
input_beta_cond1 = (
    "/data/pt_01880/Experiment1_ODC/p3/odc/results/con/native/con_left_GE_EPI2_test.nii"
)
...
if len(name_output) and len(name_sess):
    ...
    fileOUT1 = os.path.join(
        path_output,
        "sensitivity_beta_" + condition1 + "_" + condition2 + "_" + name_sess + ".nii",
    )
    fileOUT2 = os.path.join(
        path_output,
        "selectivity_beta_" + condition1 + "_" + condition2 + "_" + name_sess + ".nii",
    )
else:
    fileOUT1 = os.path.join(
        path_output, "sensitivity_beta_" + condition1 + "_" + condition2 + ".nii"
    )
    fileOUT2 = os.path.join(
        path_output, "selectivity_beta_" + condition1 + "_" + condition2 + ".nii"
    )
